...
```hyphos
soil.senary_nutrient_calc()       // Base-6 nutrient calculations
soil.senary_fertility_model()    // Senary fertility modeling
soil.senary_erosion_model()       // Base-6 erosion modeling
soil.senary_water_balance()      // Senary water balance
soil.senary_carbon_cycle()        // Base-6 carbon cycle modeling
soil.senary_productivity()       // Senary productivity modeling
soil.senary_remediation()         // Base-6 remediation planning
